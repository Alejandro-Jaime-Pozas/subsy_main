...
class LinkedBank(models.Model):
    ...
    access_token = models.CharField(max_length=255, null=True)  # Plaid access token for the bank
    cursor = models.CharField(max_length=255, default='')  # Plaid next_cursor for future transaction requests
