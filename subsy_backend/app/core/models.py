...
class Company(models.Model):
    ...
    """
    Company in the db system. Different companies
    could have the same name but different domains.
    """
...
class LinkedBank(models.Model):
    ...
    cursor = models.CharField(max_length=255, default='')  # Plaid next_cursor for future transaction requests. Will get from get_all_transactions request and need to update when refreshing transactions.
